    ...
    <div className="mx-auto flex w-full max-w-xl items-center justify-center">
      <svg viewBox="0 0 560 560" className="h-auto w-full" role="img" aria-label="The Lodestone Flywheel">
        <defs>
          ...
          >
            <path d="M0,0 L10,5 L0,10 z" fill="#A9834F" />
          </marker>
        </defs>

        <circle cx="280" cy="280" r="140" fill="none" stroke="#B7AF9E" strokeWidth="1" opacity="0.4" />
        ...
        {nodes.map((n, i) => (
          <g key={i}>
            <circle cx={n.point[0]} cy={n.point[1]} r="4" fill="#0E1B2C" />
            <text
              x={n.point[0] + n.dx}
              y={n.point[1] + n.dy}
              textAnchor={n.anchor}
